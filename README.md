...
[<img alt="Run in Gitpod" width="200 px" align="center" src="images/Gitpod.svg" />](https://hyperexecute.lambdatest.com/hyperexecute/jobs?type=gitpod&framework=Mocha&frameworkType=Puppeteer)
---
...
# How to run Puppeteer automation tests on HyperExecute (using Puppeteer-Mocha framework) — TestMu AI (Formerly LambdaTest)

* [Pre-requisites](#pre-requisites)
   - [Download HyperExecute CLI](#download-hyperexecute-cli)
   - [Configure Environment Variables](#configure-environment-variables)

* [Auto-Split Execution with Puppeteer-Mocha](#auto-split-execution-with-Puppeteer-Mocha)
   - [Core](#core)
   - [Pre Steps and Dependency Caching](#pre-steps-and-dependency-caching)
   - [Artifacts Management](#artifacts-management)
   - [Test Execution](#test-execution)

* [Matrix Execution with Puppeteer-Mocha](#matrix-execution-with-Puppeteer-Mocha)
   - [Core](#core-1)
   - [Pre Steps and Dependency Caching](#pre-steps-and-dependency-caching-1)
   - [Artifacts Management](#artifacts-management-1)
   - [Test Execution](#test-execution-1)

* [Run Puppeteer-Mocha tests on Windows , Linux and Mac platforms](#run-Puppeteer-Mocha-tests-on-windows-linux-and-mac-platforms)
...
## Auto-Split Execution with Puppeteer-Mocha
