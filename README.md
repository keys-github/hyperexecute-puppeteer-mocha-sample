# Run Puppeteer Mocha Tests with HyperExecute on TestMu AI (Formerly LambdaTest)
...
With TestMu AI (Formerly LambdaTest), you can run Puppeteer Mocha tests using HyperExecute. This sample shows how to configure Puppeteer + Mocha + HyperExecute to run on the TestMu AI cloud.
...
```bash
git clone https://github.com/LambdaTest/hyperexecute-puppeteer-mocha-sample && cd hyperexecute-puppeteer-mocha-sample
npm install
```
